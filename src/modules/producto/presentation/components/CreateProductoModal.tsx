...
import { ProiconsBoxAdd } from '../../../../shared/components/icons/icons';
    ...
    <>
      {!isControlled && (
        <Button onClick={() => setOpen(true)}>
          <ProiconsBoxAdd className="w-5 h-5 mr-2" />
          Nuevo Producto
        </Button>
      )}
                      ...
                      <FormControl>
                        <div className="relative">
                          ...
                          >
                            ...
                            {proveedoresData?.items.filter(prov => prov.provestado === 'activo').map(prov => (
                      ...
                      <FormControl>
                        <div className="relative">
                          ...
                          >
                            ...
                            {medidasData?.items.filter(mdia => mdia.mdiaestado === 'activo').map(mdia => (
