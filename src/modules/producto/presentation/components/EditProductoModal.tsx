...
export const EditProductoModal = ({ producto, open, onOpenChange }: EditProductoModalProps) => {
  ...
  return (
    ...
    >
      <ModalEntityCard 
        icon={PackageMinus}
        title={producto?.prdtonombre || 'Cargando producto...'}
        subtitle={`Código: ${producto?.prdtocodigo || ''}`}
        iconClassName="text-amber-600 bg-amber-50"
      />

      <Form {...form}>
        <form id="edit-producto-form" onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <FormControl>
                      <div className="relative">
                        ...
                        >
                          ...
                          {marcasData?.items.filter(mrc => mrc.mrcestado === 'activo' || mrc.mrcid === producto?.marca?.mrcid).map(mrc => (
                    ...
                    <FormControl>
                      <div className="relative">
                        ...
                        >
                          ...
                          {proveedoresData?.items.filter(prov => prov.provestado === 'activo' || prov.provid === producto?.proveedor?.provid).map(prov => (
                    ...
                    <FormControl>
                      <div className="relative">
                        ...
                        >
                          ...
                          {medidasData?.items.filter(mdia => mdia.mdiaestado === 'activo' || mdia.mdiaid === producto?.medida?.mdiaid).map(mdia => (
          ...
          <ModalSection title="Estado e Imagen">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <FormField
                control={form.control}
                name="prdtoestado"
